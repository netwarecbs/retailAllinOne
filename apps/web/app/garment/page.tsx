                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
                        ...
                        <div className="lg:col-span-1">
                            <Card className="h-fit shadow-md border-0">
                                ...
                                <CardContent className="p-3 space-y-2">
                                    <div className="grid grid-cols-2 gap-2">
                                        <Button variant="outline" className="h-16 flex flex-col items-center justify-center text-xs bg-gradient-to-br from-indigo-50 to-purple-50 hover:from-indigo-100 hover:to-purple-100 border-indigo-200 hover:border-indigo-300 transition-all duration-200">
                            ...
                            <Card className="h-fit mt-4 shadow-md border-0">
                                ...
                                <CardContent className="p-3 space-y-2">
                                    <div className="grid grid-cols-2 gap-2">
                                        <Button variant="outline" className="h-16 flex flex-col items-center justify-center text-xs bg-gradient-to-br from-purple-50 to-indigo-50 hover:from-purple-100 hover:to-indigo-100 border-purple-200 hover:border-purple-300 transition-all duration-200">
                            ...
                            <Card className="h-fit mt-4 shadow-md border-0">
                                ...
                                <CardContent className="p-3 space-y-2">
                                    <div className="grid grid-cols-2 gap-2">
                                        <Button variant="outline" className="h-14 flex flex-col items-center justify-center text-xs bg-gradient-to-br from-blue-50 to-indigo-50 hover:from-blue-100 hover:to-indigo-100 border-blue-200 hover:border-blue-300 transition-all duration-200">
                                            ...
                                            <span className="text-center text-xs font-medium">Suppliers</span>
                                        </Button>
                                        <Button variant="outline" className="h-14 flex flex-col items-center justify-center text-xs bg-gradient-to-br from-blue-50 to-indigo-50 hover:from-blue-100 hover:to-indigo-100 border-blue-200 hover:border-blue-300 transition-all duration-200">
                                            <div className="w-4 h-4 mb-1 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-md flex items-center justify-center">
                                                <svg className="w-2.5 h-2.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <span className="text-center text-xs font-medium">Clients</span>
                                        </Button>
                                        <Button variant="outline" className="h-14 flex flex-col items-center justify-center text-xs bg-gradient-to-br from-blue-50 to-indigo-50 hover:from-blue-100 hover:to-indigo-100 border-blue-200 hover:border-blue-300 transition-all duration-200">
                                            <div className="w-4 h-4 mb-1 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-md flex items-center justify-center">
                                                <svg className="w-2.5 h-2.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <Card className="shadow-md border-0">
                                ...
                                <CardContent className="p-4">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <p className="text-xs text-gray-500 font-medium">Invoice: #4 | Company Name</p>
                                            <p className="text-xs text-gray-500">Near Employment Exchange, Nurtoli(Kangra) H.P.</p>
                                        </div>
                                    ...
                                    <div className="mt-4 grid grid-cols-3 gap-3">
                                        ...
                                        <div className="bg-gradient-to-br from-green-50 to-green-100 p-2 rounded-lg text-center shadow-sm">
                                            ...
                                            <p className="text-sm font-bold text-green-800">0</p>
                                        </div>
                                        ...
                                        <div className="ml-6">
                                            <div className="space-y-1.5">
                                                <div className="flex items-center">
                                                    ...
                                                    <span className="text-xs">Carriage: 0</span>
                                                </div>
                                                <div className="flex items-center">
                                                    <div className="w-3 h-3 bg-green-500 rounded mr-2"></div>
                                                    <span className="text-xs">Courier: 0</span>
                                                </div>
                                                <div className="flex items-center">
                                                    <div className="w-3 h-3 bg-yellow-400 rounded mr-2"></div>
                                                    <span className="text-xs">Labour: 0</span>
                                                </div>
                                                <div className="flex items-center">
                                                    <div className="w-3 h-3 bg-red-500 rounded mr-2"></div>
                                                    <span className="text-xs">Packaging: 0</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <table className="w-full">
                                            <tbody>
                                                <tr className="border-b border-gray-100">
                                                    <td className="px-3 py-1.5 text-xs">pant</td>
                                                    <td className="px-3 py-1.5 text-xs text-right text-red-600">-13</td>
                                                </tr>
                                                <tr className="border-b border-gray-100">
                                                    <td className="px-3 py-1.5 text-xs">shirt</td>
                                                    <td className="px-3 py-1.5 text-xs text-right">5</td>
                                                </tr>
                                                <tr className="border-b border-gray-100">
                                                    <td className="px-3 py-1.5 text-xs">jacket</td>
                                                    <td className="px-3 py-1.5 text-xs text-right">12</td>
                                                </tr>
                                                <tr className="border-b border-gray-100">
                                                    <td className="px-3 py-1.5 text-xs">dress</td>
                                                    <td className="px-3 py-1.5 text-xs text-right text-red-600">-3</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <CardContent className="p-0">
                                    <div className="max-h-36 overflow-y-auto">
                                        <table className="w-full">
                                            <tbody>
                                                <tr className="border-b border-gray-100">
                                                    <td className="px-3 py-1.5 text-xs">t-shirt</td>
                                                    <td className="px-3 py-1.5 text-xs text-right text-orange-600">2</td>
                                                </tr>
                                                <tr className="border-b border-gray-100">
                                                    <td className="px-3 py-1.5 text-xs">jeans</td>
                                                    <td className="px-3 py-1.5 text-xs text-right text-orange-600">8</td>
                                                </tr>
                                                <tr className="border-b border-gray-100">
                                                    <td className="px-3 py-1.5 text-xs">shorts</td>
                                                    <td className="px-3 py-1.5 text-xs text-right text-red-600">1</td>
                                                </tr>
                                                <tr className="border-b border-gray-100">
                                                    <td className="px-3 py-1.5 text-xs">skirt</td>
                                                    <td className="px-3 py-1.5 text-xs text-right text-orange-600">4</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
