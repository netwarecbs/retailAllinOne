...
export default function SettingsPage() {
    ...
    const handleAddRate = () => {
        ...
        const existingEntry = rateChartEntries.find(entry => entry.materialId === rateForm.materialId)
        ...
        // Add to history
        const historyKey = `${rateForm.materialId}-${rateForm.customerTypeId}`
        const historyEntry = {
            id: Date.now(),
            materialName: rateForm.materialName,
    ...
    const filteredEntries = rateChartEntries.filter(entry =>
